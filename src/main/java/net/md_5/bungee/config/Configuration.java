...
public final class Configuration {
    ...
    private Configuration getSectionFor(String path) {
        ...
        return new Configuration((Map<String, Object>) section,
                (this.defaults == null) ? null : this.defaults.getSectionFor(path));
    }
    ...
    public List<?> getList(String path, List<?> def) {
        Object val = get(path, def); // Não é necessário o cast para (Object<?>)
        return (val instanceof List) ? (List<?>) val : def; // Use cast para List<?> se for necessário
    }
}
